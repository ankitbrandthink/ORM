...
import { Eye, EyeOff, Shield, BarChart3, Bell, FileDown, MessageSquare, Radio, RefreshCw, Users, ArrowLeft, Mail, CheckCircle2 } from "lucide-react";
        ...
        <div className="w-full max-w-sm">
              ...
              <form onSubmit={onSubmit} className="space-y-4">
                ...
                <div className="space-y-1">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      type="button"
                      onClick={() => { setForgotEmail(email); setMode("forgot"); setForgotError(""); }}
          ...
          {mode === "forgot" && (
            <div className="rounded-2xl border border-white/10 bg-[#1e293b] p-8 shadow-2xl">
              <button
                ...
                className="mb-5 flex items-center gap-1.5 text-xs text-slate-400 hover:text-slate-200 transition-colors"
              >
              ...
              <div className="mb-6 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-400">
                    Enter your registered email and we'll send a reset link valid for 1 hour.
                  </p>
                </div>
              </div>
          ...
          {mode === "sent" && (
            <div className="rounded-2xl border border-white/10 bg-[#1e293b] p-8 shadow-2xl text-center">
              ...
              <p className="text-xs text-slate-500 mb-6">The link expires in 1 hour. Check your spam folder if you don't see it.</p>
              <button
                onClick={() => setMode("login")}
                className="w-full rounded-xl bg-white/10 py-2.5 text-sm font-semibold text-white hover:bg-white/15 transition-colors"
              >
                Back to sign in
              </button>
            </div>
